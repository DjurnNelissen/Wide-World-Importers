...
<div class="row review">
  ...
  <div class="col-md 12 rating">
    <input id='rating' type="number" name="rating" value="" min="1" max="5">
  </div>
  <div class="col-md-12 comment">
      <input id='comment' type="textarea" name="comment" value="">
  </div>
  <button type="button" name="button" onclick="sumbmitReview(<?php
