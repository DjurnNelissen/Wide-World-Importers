...
VALUES ((SELECT MAX(PersonID) FROM people) + 1, '$fullname', '$prefferedname', '" .  $preferedname + $fullname . "', 1, '$email', '$password', 1, '$phonenumber', '$email', '2013-01-01 00:00:00', '9999-12-31 23:59:59')";
